            ...
            <div class="container">
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>Array (a list of items)</li>
                        <li>Object (a grouping of items)</li>
                        <li>Resource (a special object holding an external source of data)</li>
                        <li>Null (Represents nothing)</li>
                    </ul>
                </p>
            </div>
        </div>
